...
const CurrencypairManagement = () => {
  ...
  const [available, setAvailable] = useState("LOCAL")
  ...
  const handleAddCoins = async (coinName, shortName, chain, updatedContractAddress, category, updatedDecimal, withdrawalFee, transFee, MinWithdrawal, newMakerFee, newTakerFee, iconPath, brokerId) => {
    if (!coinName || !shortName || chain?.length === 0 || !updatedContractAddress || !updatedDecimal || !withdrawalFee || !transFee || !MinWithdrawal || !newMakerFee || !newTakerFee || !iconPath) {
      alertErrorMessage("Please fill all required detail")
      return
    }
  ...
  const handleAddPair = async (fShortName, fId, sShortName, sId, sellPrice, buyPrice, available) => {
    if (!fShortName || !fId || !sShortName || !sId || !sellPrice || !buyPrice || !available) {
      alertErrorMessage("Please fill all required detail")
      return
    }
    LoaderHelper.loaderStatus(true);
              ...
              <div className="col-xl-4">
                <div className="card mb-4">
                  <div className="card-body d-flex justify-content-center flex-column p-4 ">
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Withdrawal Fee<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                        type="number"
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Transaction Fee<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                        type="number"
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Minimum Withdrawal<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                        type="number"
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Maker FEE<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                        type="number"
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Taker FEE<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                        type="number"
                    ...
                    <div className="form-group mb-3">
                      <label className="small mb-1">
                        Coin Image<small className="text-danger"> *</small>
                      </label>
                      <input
                        className="form-control"
                    ...
                    <div className="form-group ">
                      <button className="btn btn-indigo w-100" type="button" onClick={() => handleAddCoins(coinName, shortName, chain, updatedContractAddress, category, updatedDecimal, withdrawalFee, transFee, MinWithdrawal, newMakerFee, newTakerFee, iconPath, brokerId)}>
                        Submit
                      </button>
                    </div>
                  </div>
                    ...
                    <form>
                      <div className="row">
                        <div className="mb-3 col-md-4 form-group">
                          <label className="small mb-1">
                            First Currency Pair<small className="text-danger"> *</small>
                          </label>
                        ...
                        <div className="mb-3  col-md-4 form-group">
                          <label className="small mb-1" for="inputLocation">
                            Second Currency Pair<small className="text-danger"> *</small>
                          </label>
                        ...
                        <div className="mb-3  col-md-4 form-group">
                          <label className="small mb-1" for="inputLocation">
                            Sell Price<small className="text-danger"> *</small>
                          </label>
                          <input
                        ...
                        <div className="mb-3  col-md-4 form-group">
                          <label className="small mb-1" for="inputLocation">
                            Buy Price<small className="text-danger"> *</small>
                          </label>
                          <input
                            className="form-control form-control-solid"
                            id="exampleFormControlSelect1"
                        ...
                        <div className="mb-3  col-md-4 form-group">
                          <label className="small mb-1" for="inputLocation">
                            Select Availability <small className="text-danger"> *</small>
                          </label>
                          <select
