...
const TraderDetails = (props) => {
    ...
    const handleUserData = async (userId) => {
        await AuthService.allKycData(userId).then(async result => {
            if (result?.success) {
                try {
    ...
    const columns = [
        { name: "Date/Time", wrap: true, selector: row => moment(row?.updatedAt).format("MMM Do YYYY"), },
        { name: "Currency", wrap: true, selector: row => row.currency, },
        { name: "Fee", wrap: true, selector: PriceFormat },
        { name: "Type",  wrap: true,selector: row => row.order_type, },
        { name: "Price", wrap: true, selector: row => row.price, },
        { name: "Quantity",  wrap: true,selector: row => row.quantity, },
                                    ...
                                    <div className="row align-items-center justify-content-between">
                                        <div className="col-auto mt-4">
                                            <h1 className="page-header-title">
                                                ...
                                                {props?.traderData.firstName} {props.traderData.lastName}
                                            </h1>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="card-body py-5">
                                            ...
                                            <div className="text-center">
                                                ...
                                                <div className=" text-gray">
                                                    <small>{props?.traderData.emailId}</small>
                                                </div>
                                            </div>
                                        ...
                                        <div className="tab-pane card show active" id="personalPill" role="tabpanel" aria-labelledby="personal-pill">
                                            ...
                                            <div className="card-body" >
                                                <div className="profile_data py-4 px-4" >
                                                    <div className="row" > <span className="col-3" >UserID: </span><strong className="col text-dark ">{props?.userId}</strong></div>
                                                    <hr className="my-3" />
                                                    <div className="row" > <span className="col-3" >Name: </span><strong className="col text-dark ">{props?.traderData.firstName} {props?.traderData.lastName}</strong></div>
                                                    <hr className="my-3" />
                                                    <div className="row" > <span className="col-3" >Email:</span> <strong className=" col">{props?.traderData.emailId}</strong></div>
                                                    <hr className="my-3" />
                                                    <div className="row" > <span className="col-3" >Mobile Number:</span> <strong className="col"> {props?.traderData.mobileNumber} </strong></div>
                                                    <hr className="my-3" />
                                        ...
                                        <div className="tab-pane card" id="bankaccountPill" role="tabpanel" aria-labelledby="bankaccount-pill">
                                            ...
                                            <div className="profile_data py-5 px-4" >
                                                <div className="row" >
                                                    ...
                                                    <strong className=" col text-success ">  {bankName}  </strong>
                                                </div>
                                                <hr className="my-3" />
                                        ...
                                        <div className="tab-pane card" id="masterAdmin" role="tabpanel" aria-labelledby="bankaccount-pill">
                                            ...
                                            <div className="profile_data py-5 px-4" >
                                                ...
                                                <div className="row d-flex justify-content-center" >
                                                    <button type="button" className={`btn  btn-sm btn-indigo w-25 mt-3`} onClick={() => HandleMasterAccount(props.userId, makerFee, takerFee, status)}  >Submit</button>  </div>
