...
const CurrencyManagement = () => {
  ...
  const [categoryList, setcategoryList] = useState(["Main"]);
  ...
  const filterLink = () => {
    ...
    if (filter[0]?.links?.length > 0) {
      setLinks(JSON.parse(filter[0]?.links))
    } else {
      setLinks([])
    }
  };
  ...
  const handleAddCoinWidthraw = async (inputData, coinImage, item, filterdLinks) => {
    ...
    formData.append('description', inputData?.id ? inputData?.Description : item?.description);
              ...
              <div className="row align-items-center justify-content-between">
                ...
                <div className="col-3 mt-4">
                  <select
                    ...
                    value={CoinDetail}
                    onChange={(e) => setCoinDetail(e.target.value)}
                  >
                      ...
                      <form>
                        ...
                        <div className="row gx-3 mb-3">
                          ...
                          <div className="col-md-4 form-group  mb-1">
                            ...
                            <input
                              ...
                              type="date"
                              name="issue_date"
                              value={inputData.id === item?._id ? inputData.issue_date : item?.issue_date}
                              onChange={(e) => handleInputChange(e, item?._id)}
                            ></input>
                          </div>
                          <div className="col-md-4 form-group  mb-1">
                        ...
                        <div className="row justify-content-left mt-2 mb-4" >
                          <div className="col-md-3" >
                            <button className="btn btn-dark w-100 btn-sm" type="button" onClick={handleNewRow}>Add links</button>
                          </div>
                        </div>
                        <div className="d-flex justify-content-center">

                          <button className="btn btn-indigo   btn-block w-25 mt-2" type="button" onClick={() => handleAddCoinWidthraw(inputData, coinImage, item, Links)}>
                            Submit
                          </button>
                        </div>
                      </form>
